...
INSERT INTO `parede`(ALTURA, LARGURA, AREA_TOTAL, DESCRICAO, `id_area`) VALUES(2, 5, 10, "FRENTE", 1);
INSERT INTO `parede`(ALTURA, LARGURA, AREA_TOTAL, DESCRICAO, `id_area`) VALUES(2, 10, 20, "LADO DIREITO", 1);
INSERT INTO `parede`(ALTURA, LARGURA, AREA_TOTAL, DESCRICAO, `id_area`) VALUES(2, 10, 20, "LADO ESQUERDO", 1);
